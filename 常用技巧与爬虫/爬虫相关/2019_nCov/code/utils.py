...
set_font('C:/Windows/Fonts/simhei.ttf')   # for displaying Chinese characters in plots
...
def load_chinese_data():
    data = pd.read_csv('https://raw.githubusercontent.com/BlankerL/DXY-2019-nCoV-Data/master/csv/DXYArea.csv',encoding='utf-8')
